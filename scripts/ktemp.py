...
CONFIG = {
    "MAIN_DIR": pathlib.Path("/dir/MAML_for_climate/"),
    "INPUT_DIR": "dataset/",
    "PRETRAIN_PATH": "/dir/AE/new_z500_cnn_std_2024_filter_64128_pretrained_weights",
    "START_YEAR": 1950,
    "TRAIN_END_YEAR": 2004,
    ...
    #NA
    "REGION_LAT_MAX": 60.0,
    "REGION_LON_MIN": 280.0,
    "REGION_LON_MAX": 360.0,
    #EA
    #"REGION_LAT_MAX": 50.0,
    #"REGION_LON_MIN": 90.0,
    #"REGION_LON_MAX": 150.0,
...
from Model.KTEMP import KTempCastModel
from src.gradcam_analyzer import run_gradcam_analysis
...
def setup_gpu():
    ...
    if gpus:
        try:
            ...
            print(f"GPU setup failed, will use CPU: {e}")
    else:
...
def load_climate_data(input_path):
    inp_file = input_path / "ysh_z500_diff_tzuv_inp_may_dt_19502004_std_2nd.nc"
...
def main():
    ...
    run_gradcam_analysis(
        ...
        target="regional",       # "final"/"global"/"regional"/"delta"
        max_cases=None
    )
